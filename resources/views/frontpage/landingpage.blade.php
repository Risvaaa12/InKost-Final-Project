<x-home-layout>
<body class="sticky font-sans antialiased text-gray-900 transition-all bg-white ">
    <!-- start hero -->
    <section class="relative flex items-center min-h-screen px-4 overflow-hidden bg-gray-700 cover bg-blue-teal-gradient sm:px-8 lg:px-16 ">
        ...
        <div class="relative z-10 lg:w-3/4 xl:w-2/4 h-50 lg:mt-6">
            <div >
                <h1 data-aos="zoom-in" class="text-4xl font-bold leading-tight text-yellow-400 md:text-5xl xl:text-6xl">Home is where we should feel secure and comfortable.</h1>
                ...
                <a href="#book" class="inline-block px-12 py-4 mt-8 font-bold text-white bg-yellow-400 rounded hover:bg-teal-600 hover:transition-4">Get Started</a>
            </div>
        </div>
    </section>
    <!-- end hero -->
    ...
    <div class="container sticky min-h-screen px-12 pt-16 bg-gray-100 " id="book">
        ...
        <div  class="grid gap-4 my-6 md:grid-cols-3 lg:grid-cols-4" >
            ...
            <div  class="overflow-hidden bg-white rounded shadow group" data-aos="zoom-in">
                <div class="relative ">
            ...
            <div
                x-show="modalOpen"
                x-transition
                class="fixed top-0 left-0 flex items-center justify-center w-full h-full min-h-screen px-4 py-5 bg-gray-800 bg-opacity-90"
            >
                <div @click.outside="modalOpen = false">
                <!-- Container -->
                <div class="z-10 items-center justify-center m-auto mt-12 -space-y-4 md:flex md:space-y-0 md:-space-x-4 xl:w-10/12">
                    <div class="relative z-10 -mx-4 rounded-lg group md:w-6/12 md:mx-0 lg:w-5/12">
                        <img class="rounded-lg" src="images/kost4.png" alt="">
                    </div>
                    <div class="relative group md:w-6/12 lg:w-7/12">
                        <div aria-hidden="true" class="absolute top-0 w-full h-full transition duration-500 bg-white shadow-lg rounded-2xl group-hover:scale-105"></div>
                        <div class="relative p-6 md:p-8 md:pl-12 md:rounded-r-2xl lg:pl-20 ">
                        <a id="Pos1" type="submit">
                            <h4 class="text-xl font-medium text-gray-800 uppercase transition hover:text-primary">{{$item->package_name}}</h4>
                            </a> 
                            <div class="text-gray-500 mb-2text-sm">
                            ...
                            <ul role="list" class="py-4 space-y-4 text-gray-600">
                                <li class="space-x-2">
                                    <span class="font-semibold text-yellow-400">&check;</span>
                                    <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perferendis tempore officia dignissimos ipsum, quisquam architecto.</span>
                                </li>
                                <li class="space-x-2">
                                    <span class="font-semibold text-yellow-400">&check;</span>
                                    <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perferendis tempore officia dignissimos ipsum, quisquam architecto.</span>
                            ...
                            <a href="/bookingpage">
                            <button class="relative w-48 h-12 px-6 mt-4 overflow-hidden text-lg bg-yellow-400 rounded-lg shadow hover:bg-teal-400 group">
                                <span class="relative text-black hover:text-white ">Booking</span>
                            </button>
                            </a>
                            </div>
                        </div>
    ...
    <!-- <div class="flex items-center justify-center min-h-screen px-4 py-16 bg-gray-200 2xl:container 2xl:mx-auto lg:py-16 md:py-12 py-9 md:px-6 xl:px-48 " id="BookPage">
        <div  data-aos="zoom-in" class="flex flex-col items-center justify-center w-full space-y-12 sm:w-9/12 lg:w-full lg:flex-row lg:space-x-10 2xl:space-x-36 lg:space-y-0" >
            <div class="flex flex-col items-start justify-start w-full">
                <div>
                    <p class="text-3xl font-semibold leading-7 text-gray-800 lg:text-4xl lg:leading-9">Booking Kost</p>
                </div>
                <div class="flex flex-col items-start justify-start w-full mt-8 space-y-8">
                    <input class="w-full px-2 py-4 text-base leading-4 placeholder-gray-600 border-b border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500" type="text" placeholder="Nama Depan" />
                    <input class="w-full px-2 py-4 text-base leading-4 placeholder-gray-600 border-b border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500" type="text" placeholder="Nama Belakang" />
                    <input class="w-full px-2 py-4 text-base leading-4 placeholder-gray-600 border-b border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500" type="text" placeholder="Alamat" />
                    <input class="w-full px-2 py-4 text-base leading-4 placeholder-gray-600 border-b border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500" type="number" placeholder="No Hanphone"/>
                    <input class="w-full px-2 py-4 text-base leading-4 placeholder-gray-600 border-b border-gray-200 rounded-lg dark:placeholder-gray-400 focus:ring-2 focus:ring-gray-500" type="text" placeholder="Catatan"/>
                </div>
                <button class="w-full py-4 mt-8 text-base font-medium leading-4 text-white bg-yellow-400 rounded-lg focus:outline-none focus:ring-2 dark:text-white focus:ring-gray-500 focus:ring-offset-2 focus:ring-ocus:ring-gray-800 hover:bg-teal-400 md:w-4/12 lg:w-full">Order</button>
            </div>

            <div class="flex flex-col items-start justify-start w-full p-6 bg-gray-800 rounded-lg dark:bg-gray-800 md:p-14">
                <div>
                    <h1 class="text-2xl font-semibold leading-6 text-white dark:text-white">Order Summary</h1>
                </div>
                <div class="flex flex-col items-end w-full space-y-6 mt-7">
                    <div class="flex items-center justify-between w-full">
                        <p class="text-lg leading-4 text-white ">Nama Kos :</p>
                        <p class="text-lg font-semibold leading-4 text-white " id="kosName"></p>
                    </div>
                    <div class="flex items-center justify-between w-full">
                        <p class="text-lg leading-4 text-white ">Harga :</p>
                        <p class="text-lg font-semibold leading-4 text-white" id="Harga">Rp. </p>
                    </div>
                    <div class="flex items-center justify-between w-full">
                        <p class="text-lg leading-4 text-white ">Diskon :</p>
                        <p class="text-lg font-semibold leading-4 text-white " id="Disc">Rp. </p>
                    </div>
                </div>
                <div class="flex items-center justify-between w-full mt-24">
                    <p class="text-xl font-semibold leading-4 text-white dark:text-white">Estimasi Total :</p>
                    <p class="text-lg font-semibold leading-4 text-white dark:text-white " id="Total">Rp. </p>
                </div>
            </div>
        </div>
    </div> -->
    ...
    <div class="flex flex-col text-white lg:flex-row lg:-mx-8">
        <div class="w-full lg:w-1/2 lg:px-8"  data-aos="zoom-in">
            <h2 class="mt-4 text-4xl font-bold leading-tight text-yellow-400">About Us</h2>
        ...
        <div class="md:flex">
            ...
            <h4 class="text-xl font-bold leading-tight text-yellow-400">Apa Yang Kami Berikan</h4>
        ...
        <div class="mt-8 md:flex"  data-aos="zoom-in">
            ...
            <div class="mt-4 md:ml-8 md:mt-0">
            <h4 class="text-xl font-bold leading-tight text-yellow-400">Apa Yang Kami Kerjakan</h4>
    ...
    <div class="mt-12"  data-aos="zoom-in">
        <h1 class="mt-4 text-xl text-3xl font-bold leading-tight text-yellow-400 ">Cara Booking</h1>
    </div>
    ...
    <div class="text-center text-gray-800 md:flex md:flex-wrap md:-mx-4 sm:mb-6"  data-aos="zoom-in">
        ...
        <div class="p-8 bg-yellow-400 rounded-lg hover:translate-y-4 hover:transition-all">
        ...
        <div class="pt-6 md:w-1/2 md:px-4 lg:w-1/4">
        <div class="p-8 bg-teal-400 rounded-lg hover:translate-y-4 hover:transition-all">
    ...
    <!-- Testimoni -->
    <section class="relative px-4 py-16 bg-gray-600 sm:px-8 lg:px-16 xl:px-40 lg:py-32" id="testi"  >
        <div class="px-4 py-12 lg:px-20 md:px-6" data-aos="zoom-in">
            <div class="flex flex-col items-center justify-center">
                <h2 class="text-2xl font-bold text-yellow-400 md:text-4xl">Hear from our clients.</h2>
            ...
            <div class="items-center w-full gap-6 mt-10 lg:flex">
                <div class="lg:w-1/2">
                    <div class="relative p-6 bg-teal-400 border rounded-lg hover:translate-y-2 dark:bg-gray-800 dark:border-gray-700 sm:p-10">
                        <div>
                    ...
                    <div class="flex items-center mt-4 ">
                        <div class="flex items-center justify-center w-12 h-12 border rounded-full">
                            <img src="https://i.ibb.co/R6WQhYj/Mask-Group.png" class="w-10 h-10 rounded-full" alt="profile"/>
                        </div>
                        <div class="flex flex-col items-start ml-4">
                            <p class="text-base font-semibold leading-4 text-white ">Restuuuy</p></p>
                            <p class="mt-2 text-base leading-4 text-center text-white ">Mahasiswa</p>
                        </div>
                    </div>
                </div>
                <div class="mt-16 lg:w-1/2 lg:mt-0">
                    <div class="relative p-6 bg-yellow-400 border rounded-lg hover:translate-y-2 dark:bg-gray-800 dark:border-gray-700 sm:p-10">
                        <div>
                            <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/testimonials-4-svg1.svg" alt="commas" />
                        </div>
                    ...
                    <div class="flex items-center mt-4">
                        ...
                        <div class="flex flex-col items-start ml-4">
                            <p class="text-base font-semibold leading-4 text-white ">Risvaaaa</p>
                            <p class="mt-2 text-base leading-4 text-center text-white ">Mahasiswa</p>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="bg-gradient-to-b from-gray-700 to-gray-800" >
            <div class="container px-6 py-20 m-auto md:px-12 lg:px-20" data-aos="zoom-in">
                <div class="m-auto text-center lg:w-8/12 xl:w-7/12">
                    <h2 class="text-2xl font-bold text-yellow-400 md:text-4xl">Join With Us.</h2>
                </div>
                <div class="items-center justify-center m-auto mt-12 -space-y-4 md:flex md:space-y-0 md:-space-x-4 xl:w-10/12">
                    <div class="relative z-10 -mx-4 group md:w-6/12 md:mx-0 lg:w-5/12">
                        <div aria-hidden="true" class="absolute top-0 w-full h-full transition duration-500 bg-white shadow-xl rounded-2xl group-hover:scale-105 lg:group-hover:scale-110"></div>
                        <div class="relative p-6 space-y-6 lg:p-8">
                            <h3 class="text-3xl font-semibold text-center text-gray-700">Join Member</h3>
                            <div>
                                <div class="relative flex justify-around">
                                    <div class="flex items-end">
                                        <span class="font-bold text-gray-800 text-8xl leading-0">35</span>
                                        <div class="pb-2">
                                            <span class="block text-2xl font-bold text-gray-700">%</span>
                                            <span class="block text-xl font-bold text-yellow-400">Off</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <ul role="list" class="py-6 m-auto space-y-4 text-gray-600 w-max">
                                <li class="space-x-2">
                                    <span class="font-semibold text-yellow-400">&check;</span>
                                    <span>Informasi Lengkap Kost</span>
                                </li>
                                <li class="space-x-2">
                                    <span class="font-semibold text-yellow-400">&check;</span>
                                    <span>Diskon Khusus Untukmu</span>
                                </li>
                                <li class="space-x-2">
                                    <span class="font-semibold text-yellow-400">&check;</span>
                                    <span>Menjadi Prioritas Kami</span>
                                </li>
                            </ul>
                            <p class="flex items-center justify-center space-x-4 text-lg text-center text-gray-600">
                                <span>Hubungi Kami Di</span>
                                <a href="tel:+24300" class="flex items-center space-x-2 text-yellow-400">
                                    ...
                                    <span class="font-semibold">+62 85702212370</span>
                                </a>
                                <span>atau</span>
                            </p>
                            <button type="submit" title="Submit" class="block w-full px-6 py-3 text-center transition bg-yellow-400 rounded-xl hover:bg-teal-400 active:bg-teal-400 focus:bg-teal-600">
                    ...
                    <div class="relative group md:w-6/12 lg:w-7/12">
                        ...
                        <div class="relative p-6 pt-16 md:p-8 md:pl-12 md:rounded-r-2xl lg:pl-20 lg:p-16">
                            <ul role="list" class="py-6 space-y-4 text-gray-600">
                                <li class="space-x-2">
                                    <span class="font-semibold text-yellow-400">&check;</span>
                                    <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perferendis tempore officia dignissimos ipsum, quisquam architecto.</span>
                                </li>
